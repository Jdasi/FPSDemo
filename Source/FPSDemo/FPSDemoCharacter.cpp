...
AFPSDemoCharacter::AFPSDemoCharacter()
{
	...
	FirstPersonCameraComponent->SetupAttachment(GetRootComponent(), FName("head"));
...
{	
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		EnhancedInputComponent->BindAction(ReloadAction, ETriggerEvent::Triggered, this, &AFPSDemoCharacter::DoReload);
	}
	else
	{
...
void AFPSDemoCharacter::DoFire()
{
}

void AFPSDemoCharacter::DoReload()
{
}
